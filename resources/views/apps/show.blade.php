        ...
        <article class="col-lg-8 p-3">
            <div class="row">
                <div class="col-md-2 col-3">
                    <img src="{{$app->app_icono}}" id="icono_app" class="card-img icono_app" alt="" />
                </div>
                ...
                <div class="col-md-3 col-4 d-flex flex-column align-items-center justify-content-around">
                    <button class="btn btn-primary w-75"><a href="{{$app->app_ruta}}">Instalar</a></button>
                    <button class="btn btn-primary w-75"><a href="{{$app->app_ruta}}">Sitio web</a></button>
                </div>
            </div>
            <hr>
            <div class="row">
