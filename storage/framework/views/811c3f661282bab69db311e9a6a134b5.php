...
<?php $__env->startSection('content'); ?>
    ...
    <form action="<?php echo e(route('aplicaciones.update', $aplicacion)); ?>" method="POST">
        ...
        <label>
            Usuario:
            <br>
            <input type="text" name="app_usu_id" value="<?php echo e(old('app_usu_id', $aplicacion->app_usu_id)); ?>">
        </label>
...
unset($__errorArgs, $__bag); ?>
        ...
        <label>
            Logotipo:
            <br>
            <input type="text" name="app_icono" value="<?php echo e(old('app_icono', $aplicacion->app_icono)); ?>">
        </label>
...
unset($__errorArgs, $__bag); ?>
        ...
        <label>
            Categoría:
            <br>
            <input type="text" name="app_categoria" value="<?php echo e(old('app_categoria', $aplicacion->app_categoria)); ?>">
        </label>
...
unset($__errorArgs, $__bag); ?>
        ...
        <label>
            Aplicación:
            <br>
            <input type="text" name="app_ruta" value="<?php echo e(old('app_ruta', $aplicacion->app_ruta)); ?>">
        </label>
