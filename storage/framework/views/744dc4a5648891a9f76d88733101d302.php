...
<?php $__env->startSection('title', 'Aplicacions create'); ?>
            ...
            <div class="row justify-content-center my-5">
                <div class="col-lg-8">
                    <div class="card text-center">
                        <div class="card-body">
                            <form action="<?php echo e(route('aplicaciones.store')); ?>" method="POST" enctype="multipart/form-data">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <label>
                                    Logotipo:
                                    <br>
                                    <img id="imagen" src="<?php echo e('/storage/app_iconos/' . old('icono', 'predeterminado.png')); ?>" alt="" width="50" height="50">
                                    <input type="file" name="icono" id="foto" value="<?php echo e(old('icono', 'predeterminado.png')); ?>">
                                </label>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <label>
                                    Categoría:
                                    <br>
                                    <select name="app_categoria" value="<?php echo e(old('app_categoria')); ?>">
...
<?php echo $__env->make('layouts.plantilla', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Apps\Xampp\htdocs\proyecto\resources\views/aplicaciones/create.blade.php ENDPATH**/ ?>